...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->ADCcheckedListBox->SelectedIndexChanged += gcnew System::EventHandler(this, &MyForm::ADCcheckedListBox_SelectedIndexChanged);
			// 
			// DACcheckedListBox
			// 
			...
			// durationTextBox
			// 
			this->durationTextBox->Location = System::Drawing::Point(3, 56);
			...
			this->comboBox2->Location = System::Drawing::Point(3, 16);
			...
			// progressBar1
			// 
			this->progressBar1->Location = System::Drawing::Point(3, 280);
			...
			this->flowLayoutPanel1->Size = System::Drawing::Size(175, 379);
			...
			this->checkBox1->Location = System::Drawing::Point(3, 82);
			...
			this->flowLayoutPanel2->Location = System::Drawing::Point(3, 105);
			...
			this->label7->Location = System::Drawing::Point(84, 130);
			...
			this->label8->Location = System::Drawing::Point(3, 309);
...
#pragma endregion
	...
	private: System::Void ADCcheckedListBox_SelectedIndexChanged(System::Object^ sender, System::EventArgs^ e) {

		//this->chart1->Series->Clear();
		AdcChannelNumber = this->ADCcheckedListBox->CheckedItems->Count + 1;
	...
	private: System::Void StartButton_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		if (AdcChannelNumber != 0)
		{
			...
			if (success == 1)
			{
				...
				} while (readSamples < AdcSamplesPerChannel || (liveViewMode == 1 && liveIsRunning == 0));
		...
		/*		LIH_Halt();*/
			...
			{
				MessageBox::Show("Start of acquisition failed");
				this->Cursor = Cursors::Default;
				return;
			}
	...
	/*	array<String^>^ StatuString = gcnew array<String^>{"Unknown", "Locked", "Idle", "Busy", "AdcOverflow"};
		this->label2->Text = StatuString[(int)LIH_Status()];



		if (this->label2->Text == "Idle")
			this->label2->BackColor = Color::LightGreen;
		else if (this->label2->Text == "Locked")
			this->label2->BackColor = Color::IndianRed;
		else if (this->label2->Text == "Busy")
			this->label2->BackColor = Color::LightBlue;
		else if (this->label2->Text == "AdcOverflow")
